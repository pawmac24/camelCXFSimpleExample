package com.pawelm.camel;

import java.util.HashMap;
import java.util.Map;

import com.pawelm.ws.product_service.types.ProductResponse;

public class ProductServiceImpl {
    public ProductResponse getProductDetails(com.pawelm.ws.product_service.types.ProductRequest request) {
